...
- 不使用橙色、灰色或其他第三种颜色；
- 默认输出为 PNG 格式；
- 默认优先透明背景 PNG，便于用于深色页面、Amazon A+、Banner、功能卡和后续排版；
- 白色线条与白色实心面仍保持“线面结合”，不得因为改成单色就退化为纯线稿；
- 负空间继续承担内部层级，因此白色单色也必须保持清晰结构。

只有当用户本次明确要求其他颜色、黑底白标、深色底展示、或其他文件格式时，才作为 A级｜单次参考临时覆盖；单次覆盖不得自动改写长期默认。
